...
--
-- Host: localhost
-- Generation Time: 2017-04-13 22:05:45
...
CREATE TABLE IF NOT EXISTS `i_ad` (
...
CREATE TABLE IF NOT EXISTS `i_asset` (
...
CREATE TABLE IF NOT EXISTS `i_auth_access` (
...
INSERT INTO `i_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
--
-- 表的结构 `i_common_action_log`
--

CREATE TABLE IF NOT EXISTS `i_common_action_log` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `i_goods` (
...
CREATE TABLE IF NOT EXISTS `i_goods_term` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `i_guestbook` (
  `id` int(11) NOT NULL,
...
INSERT INTO `i_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `i_menu` (
...
INSERT INTO `i_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `i_nav` (
  `id` int(11) NOT NULL,
...
INSERT INTO `i_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `i_nav_cat` (
...
INSERT INTO `i_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `i_oauth_user` (
  `id` int(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `i_options` (
...
INSERT INTO `i_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
(6, 'site_options', '            {\n            		"site_name":"系统",\n            		"site_host":"http://bad.cn/",\n            		"site_root":"",\n            		"site_icp":"",\n            		"site_admin_email":"a526584713@qq.com",\n            		"site_tongji":"",\n            		"site_copyright":"",\n            		"site_seo_title":"系统",\n            		"site_seo_keywords":"系统",\n            		"site_seo_description":"系统"\n        }', 1);
...
CREATE TABLE IF NOT EXISTS `i_plugins` (
...
CREATE TABLE IF NOT EXISTS `i_posts` (
  `id` bigint(20) unsigned NOT NULL,
...
INSERT INTO `i_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `i_role_user` (
...
CREATE TABLE IF NOT EXISTS `i_route` (
...
CREATE TABLE IF NOT EXISTS `i_slide` (
...
CREATE TABLE IF NOT EXISTS `i_slide_cat` (
  `cid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `i_terms` (
...
INSERT INTO `i_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
--
-- 表的结构 `i_term_relationships`
--

CREATE TABLE IF NOT EXISTS `i_term_relationships` (
...
INSERT INTO `i_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
(1, 'admin', '###f25434b0a5e217fd97b2737ecf52d72e', 'admin', 'a526584713@qq.com', '', NULL, 0, '2000-01-01', NULL, '127.0.0.1', '2017-04-13 15:02:20', '2017-04-13 03:02:05', '', 1, 0, 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `i_user_favorites`
--

CREATE TABLE IF NOT EXISTS `i_user_favorites` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `i_ad`
--
ALTER TABLE `i_ad`
  ADD PRIMARY KEY (`ad_id`), ADD KEY `ad_name` (`ad_name`);

--
-- Indexes for table `i_asset`
--
ALTER TABLE `i_asset`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `i_auth_access`
--
ALTER TABLE `i_auth_access`
  ADD KEY `role_id` (`role_id`), ADD KEY `rule_name` (`rule_name`) USING BTREE;

--
-- Indexes for table `i_auth_rule`
--
ALTER TABLE `i_auth_rule`
  ADD PRIMARY KEY (`id`), ADD KEY `module` (`module`,`status`,`type`);

--
-- Indexes for table `i_comments`
--
ALTER TABLE `i_comments`
...
--
-- Indexes for table `i_common_action_log`
--
ALTER TABLE `i_common_action_log`
  ADD PRIMARY KEY (`id`), ADD KEY `user_object_action` (`user`,`object`,`action`), ADD KEY `user_object_action_ip` (`user`,`object`,`action`,`ip`);

--
-- Indexes for table `i_goods`
--
ALTER TABLE `i_goods`
  ADD UNIQUE KEY `id` (`id`), ADD KEY `listorder` (`listorder`), ADD KEY `term_id` (`term_id`);

--
-- Indexes for table `i_goods_term`
--
ALTER TABLE `i_goods_term`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `i_guestbook`
--
ALTER TABLE `i_guestbook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `i_links`
--
ALTER TABLE `i_links`
  ADD PRIMARY KEY (`link_id`), ADD KEY `link_visible` (`link_status`);

--
-- Indexes for table `i_menu`
--
ALTER TABLE `i_menu`
  ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`), ADD KEY `parentid` (`parentid`), ADD KEY `model` (`model`);

--
-- Indexes for table `i_nav`
--
ALTER TABLE `i_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `i_nav_cat`
--
ALTER TABLE `i_nav_cat`
  ADD PRIMARY KEY (`navcid`);

--
-- Indexes for table `i_oauth_user`
--
ALTER TABLE `i_oauth_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `i_options`
--
ALTER TABLE `i_options`
  ADD PRIMARY KEY (`option_id`), ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `i_plugins`
--
...
--
-- Indexes for table `i_slide_cat`
--
ALTER TABLE `i_slide_cat`
  ADD PRIMARY KEY (`cid`), ADD KEY `cat_idname` (`cat_idname`);

--
-- Indexes for table `i_terms`
--
ALTER TABLE `i_terms`
  ADD PRIMARY KEY (`term_id`);

--
-- Indexes for table `i_term_relationships`
--
ALTER TABLE `i_term_relationships`
...
--
-- Indexes for table `i_user_favorites`
--
ALTER TABLE `i_user_favorites`
...
--
-- AUTO_INCREMENT for table `i_ad`
--
ALTER TABLE `i_ad`
  MODIFY `ad_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '广告id';
--
-- AUTO_INCREMENT for table `i_asset`
--
ALTER TABLE `i_asset`
  MODIFY `aid` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_auth_rule`
--
ALTER TABLE `i_auth_rule`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键',AUTO_INCREMENT=174;
--
-- AUTO_INCREMENT for table `i_comments`
--
ALTER TABLE `i_comments`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_common_action_log`
--
ALTER TABLE `i_common_action_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_goods_term`
--
ALTER TABLE `i_goods_term`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_guestbook`
--
ALTER TABLE `i_guestbook`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_links`
--
ALTER TABLE `i_links`
  MODIFY `link_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `i_menu`
--
ALTER TABLE `i_menu`
  MODIFY `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=187;
--
-- AUTO_INCREMENT for table `i_nav`
--
ALTER TABLE `i_nav`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `i_nav_cat`
--
ALTER TABLE `i_nav_cat`
  MODIFY `navcid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `i_oauth_user`
--
ALTER TABLE `i_oauth_user`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_options`
--
ALTER TABLE `i_options`
...
--
-- AUTO_INCREMENT for table `i_route`
--
ALTER TABLE `i_route`
...
--
-- AUTO_INCREMENT for table `i_slide_cat`
--
ALTER TABLE `i_slide_cat`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `i_terms`
--
ALTER TABLE `i_terms`
  MODIFY `term_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `i_term_relationships`
--
ALTER TABLE `i_term_relationships`
...
--
-- AUTO_INCREMENT for table `i_user_favorites`
--
ALTER TABLE `i_user_favorites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
