...
<header class="wy-header">
  ...
  <div class="wy-header-title">积分充值（1元=2金币）</div>
</header>
<div class="weui-content">
  <div class="weui-cells cardlist">
    <a class="weui-cell weui-cell_access" href="javascript:;" onclick='$.toast("暂未开通", "forbidden");'>
      <div class="weui-cell__bd"><p>微信充值</p></div>
      <div class="weui-cell__ft"></div>
    </a>
    <a class="weui-cell weui-cell_access" href="javascript:;" onclick='$.toast("暂未开通", "forbidden");'>
      <div class="weui-cell__bd"><p>支付宝充值</p></div>
      <div class="weui-cell__ft"></div>
    </a>
    <a class="weui-cell weui-cell_access" href="<?php echo leuu('User/Center/chongzhima');?>">
      <div class="weui-cell__bd"><p>充值码充值</p></div>
      <div class="weui-cell__ft"></div>
    </a>
  </div>
</div>
