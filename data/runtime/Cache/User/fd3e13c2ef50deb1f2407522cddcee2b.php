...
<div class="weui-navbar" style="position:fixed; top:44px; left:0; right:0; height:44px; background:#fff;">
      ...
      <a class="weui-navbar__item proinfo-tab-tit font-14 weui-bar__item" href="<?php echo leuu('User/Center/chongzhima_history');?>">充值卡兑换</a>
      <a class="weui-navbar__item proinfo-tab-tit font-14 weui-bar__item--on" href="<?php echo leuu('User/Other/getScoreGoldHis');?>">兑换记录</a>
  ...
  <div class="weui-cells wy-news-list" style="padding-top:30px">
     ...
     <?php if(is_array($result)): foreach($result as $key=>$vo): ?><a class="weui-cell weui-cell">
      <div class="weui-cell__bd">
        <p>金币兑换积分</p>
        <p><?php echo ($vo["gold"]); ?> 金币 兑换 <?php echo ($vo["score"]); ?> 积分 </p>
      </div>
