...
<div class="weui-content">
  <div class="weui-cells wy-news-list">
          <?php $newInfo=sp_sql_posts("cid:4;field:post_title,post_excerpt,object_id,term_id,smeta;order:post_hits desc;limit:200;"); ?>
    <?php if(is_array($newInfo)): foreach($newInfo as $key=>$vo): ?><a class="weui-cell weui-cell_access" href="<?php echo leuu('Portal/Index/news_page',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">
