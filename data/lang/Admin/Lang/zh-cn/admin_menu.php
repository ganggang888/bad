...
return array (
  ...
  'ADMIN_GOODS_CHANGESTATUS' => '修改状态',
  'ADMIN_GOODS_DEFAULT' => '商品管理',
  'ADMIN_GOODS_DELETE' => '删除信息',
  'ADMIN_GOODS_DELETEORDER' => '删除订单',
  'ADMIN_GOODS_EDIT' => '修改信息',
  'ADMIN_GOODS_FA' => '发货',
  'ADMIN_GOODS_GET_NUMBER' => '生成积分卡',
  'ADMIN_GOODS_INDEX' => '商品列表',
  'ADMIN_GOODS_JF_CHONGZHI_HISTORY' => '兑换码记录',
  'ADMIN_GOODS_JF_LIST' => '充值码管理',
  'ADMIN_GOODS_LISTORDERS' => '排序',
  'ADMIN_GOODS_ORDERLIST' => '订单列表',
  'ADMIN_GOODS_SKU_HISTORY' => '库存记录',
  'ADMIN_GOODS_TERM_ADD' => '添加分类',
  'ADMIN_GOODS_TERM_DELETE' => '删除分类',
  'ADMIN_GOODS_TERM_EDIT' => '修改分类',
  'ADMIN_GOODS_TERM_INDEX' => '分类管理',
  'ADMIN_GOODS__GET_LEVEL' => '获取菜单深度',
  'ADMIN_LINK_ADD_POST' => '提交添加',
  'ADMIN_LINK_CHONGZHI' => '充值记录',
